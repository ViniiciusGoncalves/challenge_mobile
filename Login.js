  ...
  const loginUsuario = () => {
    ...
    .then((response) => {
      ...
      if (data) {
        ...
        // if (data) {
        //   const dataArray = Object.values(data); // Converte o objeto em uma matriz de objetos
    ...
    // api.get("/Registro.json").then((info) => {
    //   let lista = [];
    //   let achou = false;
    //   if (info) {
  ...
  return (
    <View style={styles.container2}>
      ...
      <View style={styles2.container3}>
        <Text
          style={styles2.textContainer3}
          onPress={() => {
            props.navigation.navigate("EsquecerSenha");
          }}
        >
          Esqueceu sua senha ?
        </Text>
